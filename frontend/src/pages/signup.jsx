              ...
              <div className="space-y-3 sm:space-y-4">
                {[
                  ...
                  <div key={index} className="flex items-center space-x-3 sm:space-x-4">
                    ...
                    <span className="text-sm sm:text-base lg:text-lg text-gray-700 dark:text-gray-300">{feature}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="w-full flex items-center justify-center py-8 sm:py-12 lg:py-16">
            <div className="w-full max-w-md mx-auto px-4 sm:px-6 lg:px-0">
              <div className="text-center mb-6 sm:mb-8 lg:mb-10">
                ...
                <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">Start generating product images</p>
              </div>
              ...
              <form onSubmit={handleSignup} className="space-y-4 sm:space-y-6">
                ...
                {/* Password */}
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 sm:mb-3">Password</label>
                  <input
                    type="password"
                    value={password}
                ...
                {/* Confirm Password */}
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 sm:mb-3">Confirm Password</label>
                  <input
                    type="password"
              ...
              <div className="text-center mt-6 sm:mt-8 lg:mt-10 pt-6 sm:pt-8 border-t border-gray-200 dark:border-gray-700">
                <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <button onClick={() => navigate("/login")} className="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-medium transition-colors duration-200">
                    Sign in
                  </button>
                </p>
              </div>
